...
fisher.test(tableG)
```
We have a p-value of 1.244e-08 (0.0000001244), corresponding to a 0.00001244% likelihood that our results are due to random chance. This is highly improbable, so we reject $H_0$ in favor of $H_A$

### Conclusion
We have rejected the null hypothesis, and thus concluded that the treatment does affect the probability of contracting covid-19 in LGBTQ. Of those infected, 13.33% had taken placebo, while 86.67% had taken the vaccine. This means that, for LGTBQ, those who take the vaccine are 6.5 times more likely to contract covid-19 than those who did not.
...
fisher.test(tableD)
```
We have a p-value of 3.119e-07 (0.000003119), so we reject $H_0$ in favor of $H_A$

### Conclusion
By rejecting the null hypothesis, we conclude that drug users who take the vaccine are 5 times more likely to contract covid-19 than those who had taken placebo.
